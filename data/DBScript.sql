...
VALUES 	(1,'Regina','Gallardo','Gallardo','567','reg@mail.com','AdminProyecto',FALSE),
		...
		(3,'Alfonso','Guerrero','Guerrero','1234','pon@mail.com','AdminProyecto',FALSE),
		(4,'Alfredo','Salazar','Salazar','567','fred@mail.com','Admin',FALSE),
		(5,'Javier','Sierra','Sierra','891','jav@mail.com','Publico',FALSE);
...
VALUES 	(1,2,2,'PrepaNet Matematicas',
		...
		(6,4,3,'Reciclaje de Papel','Formas practicas de recliclar papel en casa','Ciencia',FALSE,'http://3.bp.blogspot.com/-5bPMewqA-_Q/UjidB_Dcf1I/AAAAAAAAIRo/dFwqI1QrJ7c/s320/papel-reciclado.jpg',NULL, NULL);

INSERT INTO Comments(comment_id, user_id, project_id, cDate, comment)
VALUES	(1,5,1,'2017-09-17','Muy interesante los juegos de matematicas'),
		(2,5,2,'2017-09-17','Muy interesante los temas de Quimica'),
		(3,5,3,'2017-09-17','Muy interesante la musica'),
		(4,5,4,'2017-09-17','Muy interesante los ejercicios para discapasitados'),
		(5,5,5,'2017-10-17','Fascienante super padre el deporte');
